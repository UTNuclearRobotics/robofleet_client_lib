...
#ifndef FLATBUFFERS_GENERATED_SCHEMA_FB_AFFORDANCE_PRIMITIVE_MSGS_H_
#define FLATBUFFERS_GENERATED_SCHEMA_FB_AFFORDANCE_PRIMITIVE_MSGS_H_
...
struct ScrewStamped;
struct ScrewStampedBuilder;
struct ScrewStampedT;
...
struct MapMetaData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT___METADATA) &&
           verifier.VerifyTable(__metadata()) &&
           VerifyFieldRequired<fb::RosTime>(verifier, VT_MAP_LOAD_TIME) &&
...
inline flatbuffers::Offset<MapMetaData> CreateMapMetaData(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<fb::MsgMetadata> __metadata = 0,
    const fb::RosTime *map_load_time = 0,
...
struct ScrewStampedT : public flatbuffers::NativeTable {
  typedef ScrewStamped TableType;
  std::unique_ptr<fb::MsgMetadataT> __metadata;
  std::unique_ptr<fb::std_msgs::HeaderT> header;
  std::unique_ptr<fb::geometry_msgs::PointT> origin;
  std::unique_ptr<fb::geometry_msgs::Vector3T> axis;
...
struct ScrewStamped FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ScrewStampedT NativeTableType;
  typedef ScrewStampedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT___METADATA = 4,
    VT_HEADER = 6,
    VT_ORIGIN = 8,
    VT_AXIS = 10,
    VT_IS_PURE_TRANSLATION = 12,
    VT_PITCH = 14
  };
  const fb::MsgMetadata *__metadata() const {
    return GetPointer<const fb::MsgMetadata *>(VT___METADATA);
  ...
  const fb::geometry_msgs::Point *origin() const {
    return GetPointer<const fb::geometry_msgs::Point *>(VT_ORIGIN);
  }
  const fb::geometry_msgs::Vector3 *axis() const {
    return GetPointer<const fb::geometry_msgs::Vector3 *>(VT_AXIS);
  }
  bool is_pure_translation() const {
    return GetField<uint8_t>(VT_IS_PURE_TRANSLATION, 0) != 0;
  }
  double pitch() const {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_IS_PURE_TRANSLATION) &&
           VerifyField<double>(verifier, VT_PITCH) &&
           verifier.EndTable();
  }
  ScrewStampedT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(ScrewStampedT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<ScrewStamped> Pack(flatbuffers::FlatBufferBuilder &_fbb, const ScrewStampedT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct ScrewStampedBuilder {
  typedef ScrewStamped Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add___metadata(flatbuffers::Offset<fb::MsgMetadata> __metadata) {
    fbb_.AddOffset(ScrewStamped::VT___METADATA, __metadata);
  }
  void add_header(flatbuffers::Offset<fb::std_msgs::Header> header) {
    fbb_.AddOffset(ScrewStamped::VT_HEADER, header);
  }
  void add_origin(flatbuffers::Offset<fb::geometry_msgs::Point> origin) {
    fbb_.AddOffset(ScrewStamped::VT_ORIGIN, origin);
  }
  void add_axis(flatbuffers::Offset<fb::geometry_msgs::Vector3> axis) {
    fbb_.AddOffset(ScrewStamped::VT_AXIS, axis);
  }
  void add_is_pure_translation(bool is_pure_translation) {
    fbb_.AddElement<uint8_t>(ScrewStamped::VT_IS_PURE_TRANSLATION, static_cast<uint8_t>(is_pure_translation), 0);
  }
  void add_pitch(double pitch) {
    fbb_.AddElement<double>(ScrewStamped::VT_PITCH, pitch, 0.0);
  }
  explicit ScrewStampedBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<ScrewStamped> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ScrewStamped>(end);
    fbb_.Required(o, ScrewStamped::VT_HEADER);
    fbb_.Required(o, ScrewStamped::VT_ORIGIN);
    fbb_.Required(o, ScrewStamped::VT_AXIS);
    return o;
  }
};

inline flatbuffers::Offset<ScrewStamped> CreateScrewStamped(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<fb::MsgMetadata> __metadata = 0,
    flatbuffers::Offset<fb::std_msgs::Header> header = 0,
    flatbuffers::Offset<fb::geometry_msgs::Point> origin = 0,
    flatbuffers::Offset<fb::geometry_msgs::Vector3> axis = 0,
    bool is_pure_translation = false,
    double pitch = 0.0) {
  ScrewStampedBuilder builder_(_fbb);
  builder_.add_pitch(pitch);
  builder_.add_axis(axis);
  builder_.add_origin(origin);
  builder_.add_header(header);
  builder_.add___metadata(__metadata);
  builder_.add_is_pure_translation(is_pure_translation);
  return builder_.Finish();
}

flatbuffers::Offset<ScrewStamped> CreateScrewStamped(flatbuffers::FlatBufferBuilder &_fbb, const ScrewStampedT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline MapMetaDataT *MapMetaData::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<fb::nav_msgs::MapMetaDataT> _o = std::unique_ptr<fb::nav_msgs::MapMetaDataT>(new MapMetaDataT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void MapMetaData::UnPackTo(MapMetaDataT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = width(); _o->width = _e; }
  { auto _e = height(); _o->height = _e; }
  { auto _e = origin(); if (_e) _o->origin = std::unique_ptr<fb::geometry_msgs::PoseT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<MapMetaData> CreateMapMetaData(flatbuffers::FlatBufferBuilder &_fbb, const MapMetaDataT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto ___metadata = _o->__metadata ? CreateMsgMetadata(_fbb, _o->__metadata.get(), _rehasher) : 0;
  auto _map_load_time = _o->map_load_time ? _o->map_load_time.get() : 0;
...
inline OccupancyGridT *OccupancyGrid::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<fb::nav_msgs::OccupancyGridT> _o = std::unique_ptr<fb::nav_msgs::OccupancyGridT>(new OccupancyGridT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void OccupancyGrid::UnPackTo(OccupancyGridT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = __metadata(); if (_e) _o->__metadata = std::unique_ptr<fb::MsgMetadataT>(_e->UnPack(_resolver)); }
  { auto _e = header(); if (_e) _o->header = std::unique_ptr<fb::std_msgs::HeaderT>(_e->UnPack(_resolver)); }
  { auto _e = info(); if (_e) _o->info = std::unique_ptr<fb::nav_msgs::MapMetaDataT>(_e->UnPack(_resolver)); }
  { auto _e = data(); if (_e) { _o->data.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->data[_i] = _e->Get(_i); } } }
}
...
inline ScrewStampedT *ScrewStamped::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<fb::affordance_primitive_msgs::ScrewStampedT> _o = std::unique_ptr<fb::affordance_primitive_msgs::ScrewStampedT>(new ScrewStampedT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void ScrewStamped::UnPackTo(ScrewStampedT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = __metadata(); if (_e) _o->__metadata = std::unique_ptr<fb::MsgMetadataT>(_e->UnPack(_resolver)); }
  { auto _e = header(); if (_e) _o->header = std::unique_ptr<fb::std_msgs::HeaderT>(_e->UnPack(_resolver)); }
  { auto _e = origin(); if (_e) _o->origin = std::unique_ptr<fb::geometry_msgs::PointT>(_e->UnPack(_resolver)); }
  { auto _e = axis(); if (_e) _o->axis = std::unique_ptr<fb::geometry_msgs::Vector3T>(_e->UnPack(_resolver)); }
  { auto _e = is_pure_translation(); _o->is_pure_translation = _e; }
  { auto _e = pitch(); _o->pitch = _e; }
}

inline flatbuffers::Offset<ScrewStamped> ScrewStamped::Pack(flatbuffers::FlatBufferBuilder &_fbb, const ScrewStampedT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateScrewStamped(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<ScrewStamped> CreateScrewStamped(flatbuffers::FlatBufferBuilder &_fbb, const ScrewStampedT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const ScrewStampedT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto ___metadata = _o->__metadata ? CreateMsgMetadata(_fbb, _o->__metadata.get(), _rehasher) : 0;
  auto _header = _o->header ? CreateHeader(_fbb, _o->header.get(), _rehasher) : 0;
  auto _origin = _o->origin ? CreatePoint(_fbb, _o->origin.get(), _rehasher) : 0;
  auto _axis = _o->axis ? CreateVector3(_fbb, _o->axis.get(), _rehasher) : 0;
  auto _is_pure_translation = _o->is_pure_translation;
  auto _pitch = _o->pitch;
  return fb::affordance_primitive_msgs::CreateScrewStamped(
      _fbb,
      ___metadata,
      _header,
      _origin,
...
#endif  // FLATBUFFERS_GENERATED_SCHEMA_FB_AFFORDANCE_PRIMITIVE_MSGS_H_
